    ...
    <div>
        <b-jumbotron text-variant="white"
            ...
            <template #lead>
                ...
                <br>
                ERC20 Generator is the easiest and fastest way to create your own ERC20 token on the Ethereum network. No coding skills are required.
            </template>
        </b-jumbotron>
                            ...
                            <b-row>
                                ...
                                <b-col md="6" lg="4">
                                    <b-card header="Token Features"
                                        ...
                                        <b-form-group
                                                description="Recover any ERC20 token sent into the contract for error.">
                                ...
                                <b-col md="12" lg="4">
                                    <b-card header="Token Type and Network"
                                        ...
                                        <b-alert show variant="warning" v-if="currentNetwork !== 'mainnet'">
                                            ...
                                            <hr>
                                            To deploy on Main Network you must select Ethereum.
                                        </b-alert>
                                        <b-link href="https://etherplan.com/2021/03/02/how-to-connect-metamask-to-ethereum-classic/15512/"
                                                target="_blank">
                                            <small>How to connect MetaMask to Ethereum Network?</small>
                                        </b-link>
                                    </b-card>
