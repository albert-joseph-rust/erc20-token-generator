    ...
    <div class="features-table">
        ...
        <b-card-group deck>
            <b-card class="mb-3" sub-title="Operable Token (ERC1363)">
                <b-card-text>
                    The Operable Token is a ERC20 compatible Token that can make a
        ...
        <b-row>
            <b-col lg="12">
                <b-alert class="mb-3" variant="warning" show>
                    ...
                    <p>
                        Deploying BasicERC20 for FREE or EasyERC20, a link pointing to this page will be added to
                        your contract.
